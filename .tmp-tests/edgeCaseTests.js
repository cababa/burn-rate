...
var runTests = () => {
  ...
  }
  {
    ...
    const mockXCard = { ...GAME_DATA.cards.cto_commit, id: "x_mock", cost: -1, effects: [{ type: "damage", value: 5, target: "enemy" }] };
  ...
  }
  {
    ...
    state.drawPile = Array(5).fill(GAME_DATA.cards.cto_commit);
  ...
  {
    let state = createMockState();
    state.hand = Array(MAX_HAND_SIZE - 1).fill(GAME_DATA.cards.cto_commit);
    const drawCard = { ...GAME_DATA.cards.cto_commit, id: "draw_2", cost: 0, effects: [{ type: "draw", value: 2 }] };
