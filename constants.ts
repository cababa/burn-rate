...
export const ACT1_EVENTS: EventData[] = [
    ...
    // === NEW CHOICE-BASED EVENTS ===
    {
        id: 'refactoring_session',
        name: 'The Refactoring Session',
        description: 'Your tech lead insists on a code review session. Three paths forward...',
        choices: [
            {
                id: 'delete',
                label: 'Delete Dead Code',
                description: 'Remove a card from your deck',
                effects: [{ type: 'remove_card_choice', value: 1 }]
            },
            {
                id: 'rewrite',
                label: 'Rewrite a Module',
                description: 'Transform a card into a new one',
                effects: [{ type: 'transform_card_choice', value: 1 }]
            },
            {
                id: 'optimize',
                label: 'Optimize Performance',
                description: 'Upgrade a card',
                effects: [{ type: 'upgrade_card_choice', value: 1 }]
            }
        ]
    },
    {
        id: 'sprint_review',
        name: 'The Sprint Review',
        description: 'Time to present what you built this sprint. The team is impressed...',
        choices: [
            {
                id: 'celebrate',
    ...
    {
        id: 'venture_scout',
        name: 'The Venture Scout',
        description: 'A talent scout from a major accelerator wants to meet. They bring gifts...',
        choices: [
            {
                id: 'snack',
                label: 'Take the Snack',
                description: 'Heal 25 Runway (33% of max)',
                effects: [{ type: 'gain_hp', value: 25 }]
            },
            {
                id: 'gear',
                label: 'Take the Gear',
            ...
            {
                id: 'mystery',
                label: 'Take the Mystery Box',
                description: 'Gain random relic, add Burnout curse',
                effects: [
                    { type: 'gain_relic' },
                    { type: 'add_status_card', statusId: 'status_burnout' }
                ]
    ...
    {
        id: 'clean_codebase',
        name: 'The Clean Codebase Initiative',
        description: 'A senior engineer offers to help you clean up your technical debt...',
        choices: [
            {
                id: 'accept',
                label: 'Accept Help',
            ...
            },
            {
                id: 'decline',
                label: 'Decline',
                description: 'No time for refactoring',
                effects: [{ type: 'nothing' }]
            }
        ]
    },
    {
        id: 'the_sacrifice',
        name: 'The Sacrifice',
        description: 'The startup gods demand an offering. Remove a card to gain their blessing...',
        choices: [
            {
                id: 'sacrifice',
                label: 'Make the Sacrifice',
                description: 'Remove a card, gain rare relic',
                effects: [
                    { type: 'remove_card_choice', value: 1 },
                    { type: 'gain_relic', relicRarity: 'rare' }
                ]
            },
            {
                id: 'refuse',
                label: 'Refuse',
                description: 'Keep your cards',
                effects: [{ type: 'nothing' }]
            }
        ]
    },
    {
        id: 'burndown_chart',
        name: 'The Burndown Chart',
        description: 'Your velocity is falling behind. Drastic measures might be needed...',
        choices: [
            {
                id: 'crunch',
                label: 'Crunch Time',
                description: 'Lose 15 Runway, remove a card',
                effects: [
