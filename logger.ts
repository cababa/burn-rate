...
export type LogCategory =
    | 'TURN_START' | 'TURN_END'
    | 'CARD_PLAY' | 'CARD_DRAW' | 'CARD_EXHAUST' | 'CARD_BURN' | 'CARD_DISCARD' | 'CARD_ADDED_TO_HAND' | 'CARD_RETAINED' | 'CARD_PLAY_FAILED' | 'CARD_PLAY_FALLBACK' | 'CARD_BURNED' | 'CARD_DISCARDED'
